...
export default async function Header() {
  ...
  return (
    <header className="sticky right-0 top-0 flex h-[54px] items-center justify-between border-neutral-200 px-4 py-3 dark:border-neutral-800 md:h-[74px] md:px-8 md:py-4 xl:h-[81px] xl:border-b xl:bg-white dark:xl:bg-neutral-950">
